...
import { X, Check, XCircle, Clock, UserCheck, PhoneOff, Heart } from 'lucide-react';
...
const QUICK_STATUSES: { status: ContactStatus; icon: React.ReactNode; color: string }[] = [
    { status: 'agreed', icon: <Check size={16} />, color: 'var(--color-success)' },
    { status: 'refused', icon: <XCircle size={16} />, color: 'var(--color-danger)' },
    { status: 'no_answer', icon: <PhoneOff size={16} />, color: 'var(--color-warning)' },
